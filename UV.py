...
def mainPage():
    ...
    with st.form("my_form"):
        ...
        if submitted:
            ...
            strCol = pd.json_normalize(pd.json_normalize(placeData['results'][1])['photos'].str[0] ).photo_reference.apply(lambda x: st.image('https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=' + str(x)+ '&key=' + "AIzaSyDP1s5lb7PQH1F0w4BYsBMLIOfDJZlwFDI"))
